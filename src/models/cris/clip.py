...
class AttentionPool2d(nn.Module):
    ...
    def resize_pos_embed(self, pos_embed: torch.Tensor, input_shpae: Tuple[int, int]):
...
class CLIP(nn.Module):
    ...
    def build_attention_mask(self, context_length: int):
...
def build_model(state_dict: Mapping[str, torch.Tensor], txt_length: int):
